...
if($_POST["password"] == $_POST["con_password"]) {
  ...
  $sql="insert into patient_details (patfname,patsname,patdob,patmob,patemail,pataddress,username,password)values('" . $fname . "','" . $sname . "','" . $dob ."'," . $mob .",'" . $email ."','" . $address ."','" . $username . "','" . $password. "')";
