...
<body>
<div class="subbody">
<div class="head">UPDATE DOCTOR DETAILS</div><br><br>
...
die("Not Connected");
$sql="select * from doctor_details where docid=" . $did ;
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  if($_POST["password"] == $_POST["con_password"]) {
    ...
    $sqlp="update doctor_details set special='".$special."',docfname ='".$fname."' ,docsname='".$sname."',docdoj='".$doj."',docmob='".$mob."',docemail='".$email."',docaddress='".$address."',username='".$username."',password='".$password."' where docid=". $did."";
