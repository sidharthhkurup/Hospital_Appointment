...
<body>
<div class="subbody">
<div class="head">UPDATE PATIENT DETAILS</div><br><br>
<?php
session_start();
...
die("Not Connected");
$sql="select * from patient_details where patid=" . $pid ;
...
if($_POST["password"] == $_POST["con_password"]) {
  ...
  $sqlp="update patient_details set patfname ='".$fname."' ,patsname='".$sname."',patdob='".$dob."',patmob='".$mob."',patemail='".$email."',pataddress='".$address."',username='".$username."',password='".$password."' where patid=". $pid."";
